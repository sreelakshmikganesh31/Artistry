...
SECRET_KEY = 'django-insecure-9w2ggnw1s!10a3zesqh&bs#w4ie+sjci4+6$d#lvo9xzo$29o='
...
AUTH_USER_MODEL = 'Art_pro_app.CustomUser'
...
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': timedelta(minutes=60),  # Increase to 1 hour
